...
if(version_compare(JVERSION, '1.6.0', '<')) {
	...
	if($num == 0) {
		...
		$query = "INSERT INTO `#__allvideoshare_licensing` (`id`, `licensekey`, `type`, `logo`, `logoposition`, `logoalpha`, `logotarget`, `displaylogo`) VALUES (1, 'Enter your License Key here...', 'upload', '', 'bottomleft', 50, 'http://allvideoshare.mrvinoth.com/', 0)";
		$db->setQuery($query);
		$db->Query();
	}
